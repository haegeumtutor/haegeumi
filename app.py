...
첫 번째 질문 - 학생 답- 학생 답에 대한 피드백- 두 번째 질문- 학생 답- 학생 답에 대한 피드백- 세 번째 질문- 학생 답- 학생 답에 대한 피드백- 마지막 질문- 학생 답- 학생 답에 대한 피드백- 마지막 질문 후에는 마음지도와 성장 뱃지 수여하기 순서로 대화하세요
마지막 질문 후, 학생이 답을 하면, 해금 마음 지도와 성장 뱃지를 수여합니다. 
순서대로 진행해 주세요.  그리고 바이올린 이모티콘은 전부 삭제해줘! 이건 국악이거든
...
5) 마지막 질문이 끝나면 학생의 성찰 깊이에 따라 '해금 마음 지도'를 시각화하여 보여줍니다.
